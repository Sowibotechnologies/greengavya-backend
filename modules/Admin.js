...
db.query("SELECT admin.user_id,admin.email,admin.username,admin.password,permission.permission_id,permission.p_create,permission.p_alter,permission.p_delete,permission.c_create,permission.c_alter,permission.c_delete,permission.o_alter,permission.u_alter,permission.a_create,permission.a_alter,permission.a_delete,permission.courier_create,permission.courier_delete from admin INNER JOIN permission ON admin.permission_id = permission.permission_id", function(err, result){
if(err){
console.log(err);
}
...
courier_create: input.courier_create,
courier_delete: input.courier_delete,
