        ...
        return(
            <React.Fragment>
                ...
                <div className="text-center">
                    <img alt="Shopper icon" className="card-head-img" src="/images/shopper.png"/>
                    <span className="card-head-title">Shoppers</span>
                </div>
    ...
    return(
        <tr className="showProduct-tableBody left-cell">
            {props.data.verified === "true" ?
                <td style={{textTransform:'capitalize'}}>{props.data.username}</td>
                :
                <td style={{textTransform:'capitalize',color:'red'}}>Unverified</td>
            }
