...
class CourierSignup extends React.Component{
    ...
    verifySignup(){
        fetch('/api/delivery/verifysignup',{
            method:'GET',
            headers: {
    ...
    render(){
        ...
        <div className="container-fluid login-main" >
            <div className="container login-inner text-left" >
                <img src="/images/delivery.png" width='70' style={{margin:'auto'}} className="img-responsive"/>
