module.exports = {
    ...
    RandomAddressId : function(){
        var randomID = "1200" + Math.floor((Math.random() * 1000000000) + 1);
        return randomID;
    },
	...
	RandomCourierID : function(){
        var randomID = "DA_"+Math.random().toString(36).substring(2, 6) +"-"+ Math.random().toString(36).substring(2, 15);
        return randomID;
    }
}
